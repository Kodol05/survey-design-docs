...
/**
 * 사내 통계를 표시할 수 있는 최소 인원 (00 D-24 → D-42).
 *
 * **30에서 10으로 내렸다 (2026-08-24 사용자 결정).** 30은 통계 쪽 관행에서
 * 온 값인데, 회사 인원이 50명 안쪽이라 초기에는 화면 대부분이 「n 부족」으로
 * 막혀 아무것도 못 본다.
 *
 * ⚠️ **10명에서 나오는 값은 거의 다 「불확실」로 뜬다.** 10명이면 |r|이
 *    .63쯤은 돼야 신뢰구간이 0을 벗어난다. 막지 않을 뿐이지 믿을 만해지는
 *    것은 아니다 — 그래서 n 배지와 신뢰구간 표시는 그대로 둔다.
 */
