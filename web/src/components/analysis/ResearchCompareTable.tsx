  ...
  return (
    <div>
      ...
      <p className="text-ink-secondary mb-6">
        {off === 0 ? (
          <>
            맞대 볼 수 있는 <span className="tabular">{data.comparable}</span>칸 모두
            연구값이 우리 신뢰구간 안에 들어옵니다.
          </>
        ) : (
          <>
      ...
      */}
      <p className="text-axis text-ink-muted mt-4">
        두 숫자의 차이가 아니라 <strong>연구값이 우리 95% 구간 안에 드는지</strong>로
        봅니다. 사람이 늘면 구간이 좁아져 판정이 날카로워집니다.
        {data.noResearch > 0 && (
