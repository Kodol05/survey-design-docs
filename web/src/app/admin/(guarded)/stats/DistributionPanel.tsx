  ...
  return (
    <section>
      ...
      <Note label="이 그림을 어떻게 읽는지" className="mt-12">
        <p className="mb-2">
          <strong>옅은 상자는 가운데 절반</strong>입니다 — 아래에서 4분의 1
          지점부터 4분의 3 지점까지. 세로선은 중앙값입니다. 상자가 좁으면 다들
          비슷하다는 뜻이고, 넓으면 사람마다 많이 다르다는 뜻입니다.
        </p>
        <p className="mb-2">
          <strong>평균을 앞에 두지 않았습니다.</strong> 이 눈금은 문항 가운데를
          50으로 잡은 것이라 비교할 바깥 기준이 없습니다. 「평균 51」은 「보통보다
          조금 높다」가 아니라 그냥 문항이 그렇게 만들어졌다는 뜻에 가깝습니다.{" "}
          <strong>사내에서 서로 견주는 것만</strong> 말이 됩니다.
        </p>
        <p>
          점이 두 덩어리로 갈라져 있으면 그 축에서 회사가 두 무리로 나뉜다는
          뜻입니다. 최소~최대 폭만 봐서는 안 보이는 것이라 여기 점을 그대로
          둡니다.
        </p>
      </Note>
    </section>
